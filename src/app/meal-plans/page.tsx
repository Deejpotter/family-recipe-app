						...
						<thead>
							<tr>
								...
								{days.map((day) => (
									<th
										key={day.shortDate}
										className="p-3 bg-gray-100 text-left min-w-[150px]"
									>
