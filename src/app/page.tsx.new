    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow container mx-auto p-6">
        ...
        <section className="text-center py-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Your Personal Recipe Collection</h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
            Store your favorite recipes, create meal plans, and simplify grocery shopping
          </p>
        ...
        <section className="py-12">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">Store and organize all your favorite family recipes in one place.</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">Create weekly and monthly meal plans based on your preferences.</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">Automatically generate shopping lists from your meal plans.</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">Track what ingredients you have on hand and get notified when you're running low.</p>
            </div>
          </div>
        </section>
      </main>
